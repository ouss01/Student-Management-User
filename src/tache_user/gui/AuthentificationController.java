    ...
    private void authentification(ActionEvent event) throws SQLException, IOException {
       ...
       try {            System.out.println(authemail.getText()+authmdp.getText());
                        ...
                        if (rs.next()) {
                            ...
                            */
                           if (rs.getString("role_user").equals("Professeur")){
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("WelcomeProfesseur.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
                                 primaryStage.setTitle("Welcome Professeur");  
                                 primaryStage.centerOnScreen();  
                                 primaryStage.setResizable(false);  
                                 primaryStage.setOpacity(1);  
                                 primaryStage.show();  
                            ...
                            else if (rs.getString("role_user").equals("Etudiant")){
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("WelcomeEtudiant.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
                                 primaryStage.setTitle("Welcome Etudiant");  
                                 primaryStage.centerOnScreen();  
                                 primaryStage.setResizable(false);  
                                 primaryStage.setOpacity(1);  
                                 primaryStage.show();  
                            ...
                            else if (rs.getString("role_user").equals("admin")){
...
*/
                            ...
                            alert.setHeaderText("WELCOME TO BlackBoard");
                            ...
                            alert.setContentText("Can not connect to BlackBoard");
                            alert.show();
                        }
